package com.tilapio.back_end.controller;

import com.tilapio.back_end.model.User; // Importa a classe User que representa a entidade de usuário
import com.tilapio.back_end.repository.UserRepository; // Importa a interface UserRepository para acessar o banco de dados
...
public class UserController {
    ...
    @PutMapping("/{id}") // Mapeia requisições PUT para /api/users/{id} para atualizar um usuário existente
